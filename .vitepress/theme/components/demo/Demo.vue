...
onMounted(() => {
  new TypeIt(block.value, {
    ...
    .type('<br><span class="token title"># Seja bem-vindo ao Slidev!</span><br><br>', { delay: 400 })
    .type('Apresentação de slides para desenvolvedores', { delay: 400 })
    .move('START', { speed: 0 })
    .type('<br>')
    .move('START')
    .exec(pause)
    ...
    .type('- 📄 Escreva slides em um único arquivo Markdown<br>', { delay: 800 })
    .type('- 🌈 Temas, blocos de código, componentes interativos<br>', { delay: 800 })
    .type('- 😎 Leia a documentação para aprender mais!', { delay: 800 })
